...
namespace Microsoft.Xna.Framework.Graphics
{
    public partial class RenderTargetCube
    {
        ...
        private void PlatformConstruct(GraphicsDevice graphicsDevice, bool mipMap, SurfaceFormat preferredSurfaceFormat, DepthFormat preferredDepthFormat, int preferredMultiSampleCount, RenderTargetUsage usage)
        {
